    ...
    return `
      <div class="relative bg-white border border-slate-100 rounded-xl p-3 shadow-sm border-l-4 ${corClass} transition-all hover:shadow-md">
        ...
        <div class="flex justify-between items-start mb-1 text-[12px]">
          <i class="fa-solid fa-gift ${textClass} opacity-60"  style="background:#FFC107;color:#C62828; padding:10px;   border-radius:8px;  font-size:11px; display:inline-flex; align-items:center; justify-content:center; "></i>
